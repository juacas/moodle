...
$string['anonymous'] = 'Confidential (Users\' details will not be displayed alongside the answers.)';
$string['anonymous_voting_undergoing'] = 'This uncorrelated, anonymous poll is not over. Come back later.';
$string['anonymous_voting_undergoing_help'] = 'The polling statistics, to be truly anonymous, can\'t be traced during the votation.';
$string['truly_anonymous'] = 'Fully anonymous. Nobody can identify the author of the answers.';
