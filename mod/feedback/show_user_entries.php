...
$feedbackstructure = new mod_feedback_completion($feedback, $cm, 0, true, false, $userid);
...
echo '<center><input type="button" onclick="window.print();" value="Imprimir resultados enviados" /></center>';
